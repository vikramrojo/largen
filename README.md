...
publish of a version that already exists, so `largen@0.3.3/dist/largen.css` is the same
file forever.

```html
<link rel="stylesheet"
      href="https://cdn.jsdelivr.net/npm/largen@0.3.3/dist/largen.css"
      integrity="sha384-rjSzw96UVmsmlpi43lByIuQcYBTaHAAb4SCdNqyO1DL2KKUm6wre4gk33nxMgsEO"
...
```
curl -s https://cdn.jsdelivr.net/npm/largen@0.3.3/dist/largen.css |
...
sharing one build id have identical CSS differing only in the version string — 0.3.3, 0.3.2, 0.3.1 and
